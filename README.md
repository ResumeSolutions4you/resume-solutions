...
<head>
  ...
  <title>Resume Solutions by Tracy</title>
...
<body oncontextmenu="return false;">
  <header>
    <h1 class="size" >Resume Solutions</h1>
    <p class="pie">Professional Resume Writing & Formatting Services</p>
  </header>
  <main>
    <section>
      <h2>Choose Your Format</h2>
      <p>Select from various modern, classic, and creative resume formats. Once you've selected a template, contact Tracy to begin crafting your resume.</p>
    </section>
     <!-- This is where to add the templates -->
    <section class="template-gallery">
      <h2>Resume Template Gallery</h2>
     <div>
       <input type="checkbox" id="zoom_img">
       <label for="zoom_img">
      <img class="zoom" src = "https://i.imgur.com/nn5Jxgt.jpeg" style="position: relative; left: 50px;" width="500" height="300">
      <img class="zoom" src = "https://i.imgur.com/zPhOlyR.jpeg" style="position: relative; left: 120px;" width="500" height="300">
      <img class="zoom" src = "https://i.imgur.com/bGlve3X.jpeg" style="position: relative; left: 190px;" width="500" height="300">
      <img class="zoom" src = "https://i.imgur.com/LamxC2o.jpeg" style="position: relative; left: 260px;" width="500" height="300">
      <img class="zoom" src = "https://i.imgur.com/5cdAl94.jpeg" style="position: relative; left: 330px;" width="500" height="300">
      <img class="zoom" src = "https://i.imgur.com/DQD0CQV.jpeg" style="position: relative; left: 400px;" width="500" height="300">
  ...
  <section class="contact">
    ...
    <p>Our services include resume writing, cover letters, and one-on-one consultations. At Resume Solutions, you’re not just getting a document — you’re getting a strategic career tool designed to help you stand out in a competitive job market. Let’s build your future — one resume at a time.</p>
  </section>
  ...
  <!-- This code can not be altared or used by any other indivual besides the resume solutions company this is under full copywright protection where no one is allowed to modify, copy, use, or any way shape or form do anythign to it-->
  </main>
</body>
</html>
